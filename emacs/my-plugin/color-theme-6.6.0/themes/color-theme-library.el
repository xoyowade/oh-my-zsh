...
fonts."
  ...
  (let ((color-theme-is-cumulative t))
	...
	(height . 25)
	(background . dark))
       (default ((t (:stipple nil :background "snow2" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 240 :width normal :family "adobe-courier"))))

       (bold ((t (:bold f :underline t))))
       (bold-italic ((t (:bold f :underline t))))
       (font-lock-builtin-face ((t (:bold f :foreground "Red"))))
       (font-lock-comment-face ((t (:bold f :foreground "Firebrick"))))
       (font-lock-constant-face ((t (:bold f :underline t :foreground "Blue"))))
       (font-lock-function-name-face ((t (:bold f :foreground "Blue"))))
       (font-lock-keyword-face ((t (:bold f :foreground "Purple"))))
       (font-lock-string-face ((t (:bold f :foreground "DarkGreen"))))
       (font-lock-type-face ((t (:bold f :foreground "ForestGreen"))))
       (font-lock-variable-name-face ((t (:bold f :foreground "DarkGoldenrod"))))
       (font-lock-warning-face ((t (:bold f :foreground "Red"))))
       (highlight ((t (:background "black" :foreground "white" :bold 0))))
       (info-menu-5 ((t (:underline t :bold f))))
       (info-node ((t (:bold f))))
       (info-xref ((t (:bold f ))))
       (italic ((t (:bold f :underline t))))
       (modeline ((t (:background "black" :foreground "white" :bold 0))))
       (modeline-buffer-id ((t (:background "black" :foreground "white" :bold 0))))
       (modeline-mousable ((t (:background "black" :foreground "white" :bold 0))))
       (modeline-mousable-minor-mode ((t (:background "black" :foreground "white" :bold 0))))
       (region ((t (:background "black" :foreground "white" :bold 0))))
       (secondary-selection ((t (:background "black" :foreground "white" :bold 0))))
       (underline ((t (:bold f :underline t))))))))
